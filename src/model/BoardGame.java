...
public class BoardGame implements Serializable
{
    ...
    {
        // the program will check if there is any invalid input
        ...
        // the loop tries to find if there are any prohibited characters
        // if that is the case, it throws an exception, which will be handled by the controller
        ...
        // if the program got to this point it means that there are no problems with the introduced data,
        // so it can actually create the object
        this.title = title;
        this.ownerID = ownerID;
        this.description = description;
        this.genre = genre;
        gameAction = null; // when the object is being created for the first time, its status should be set to available
        this.ratingList = new RatingList(); // when the object is being created for the first time, it doesn't have any ratings
    }
